...
public class TelaEmJogo extends javax.swing.JPanel {
    ...
    private void preInit() {
        localButtons = new JButton[20][12]; //Primeiro largura depois altura
        posicaoBotoes = new HashMap();

    }

    private void postInit() {
        panelMap.setLayout(new GridLayout(12, 20, 2, 2));
        for (int i = 0; i < localButtons.length; i++) {
            for (int j = 0; j < localButtons[i].length; j++) {
                ...
                btn.setIcon(new ImageIcon("resources/campoVerde.png", "Um campo aparentemente vazio"));
                panelMap.add(btn);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panelMenuRotativo.setMaximumSize(new java.awt.Dimension(200, 32767));
        panelMenuRotativo.setMinimumSize(new java.awt.Dimension(200, 0));
        panelMenuRotativo.setPreferredSize(new java.awt.Dimension(200, 0));
        ...
        panelMenuEscolhasLayout.setHorizontalGroup(
            ...
            .addGroup(panelMenuEscolhasLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelMenuEscolhasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnAtacar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnEspecialidade, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addComponent(panelMenuRotativo, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        );
        panelMenuEscolhasLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelMenuEscolhasLayout.createSequentialGroup()
                .addComponent(panelMenuRotativo, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(5, 5, 5)
                        .addComponent(panelMap, javax.swing.GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(5, 5, 5)
    ...
    void atualizaTurno(Turno turno) {
        if (turno.getTime() == Time.PRETO) {
            lblJogadorTurno.setText("Adversário");
        } else {
            lblJogadorTurno.setText("Você");
        }
    ...
    void atualizaMapa(HashMap<Dimension2D, Lugar> locaisAlterados, Time timeDoJogadorLocal){
        locaisAlterados.forEach((coordenada, lugar) -> {
            localButtons[(int)coordenada.getWidth()][(int)coordenada.getHeight()].setIcon(new ImageIcon(lugar.getIcone(timeDoJogadorLocal)));
        });
    }

    void atualizaTela(Ato ato) {
        //Panel Turno
        atualizaTurno(ato.getTurno());
        
        //Panel Vida
        vidaPersonagemUmVoce.setValue(ato.getPersonagens()[0][0].getPorcentagemVidaAtual());
        vidaPersonagemDoisVoce.setValue(ato.getPersonagens()[0][1].getPorcentagemVidaAtual());
        vidaPersonagemUmAdversario.setValue(ato.getPersonagens()[1][0].getPorcentagemVidaAtual());
        vidaPersonagemDoisAdversario.setValue(ato.getPersonagens()[0][2].getPorcentagemVidaAtual());
        
        //Mapa
        atualizaMapa(ato.getAlteracoesMapa(), ato.getTurno().getTime());
    }
