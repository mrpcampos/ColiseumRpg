...
public class ControladorNetGames implements OuvidorProxy{
    ...
    public void conectar(String ipDoServidor, Time identificadorDoJogador){
        try {
            ...
            Logger.getLogger(ControladorNetGames.class.getName()).log(Level.SEVERE, null, ex);
            ControladorTelas.errorDialog("ArquivoMultiplayerExcption - é, deu ruim.");
        }
    }
    ...
    /**
     * 
     * @param posicao indica qual a posição na 'fila' do jogador, se for 1 sera o primeiro, se for 2 será o segundo
     */
    @Override
